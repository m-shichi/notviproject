...
public class CustomPopupWindow {
	...
	public CustomPopupWindow(View anchor) {
		this.anchor = anchor;
		this.mPopup = new PopupWindow(anchor.getContext());
		...
		mPopup.setTouchInterceptor(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				if (event.getAction() == MotionEvent.ACTION_OUTSIDE) {
					CustomPopupWindow.this.mPopup.dismiss();
	...
	public void showDropDown(int xOffset, int yOffset) {
		...
		mPopup.setAnimationStyle(R.style.Animations_PopDownMenu);
	...
	public void showLikeQuickAction(int xOffset, int yOffset) {
		...
		mPopup.setAnimationStyle(R.style.Animations_PopUpMenu_Center);
		...
		if (rootHeight > anchorRect.top) {
			...
			mPopup.setAnimationStyle(R.style.Animations_PopDownMenu_Center);
		}
